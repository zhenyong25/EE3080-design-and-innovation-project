...
(about_widget_class,
 about_widget_base_class) = (uic.loadUiType(edclient.module_path +
                                            '/ui/dialogs/about.ui'))
...
class AboutDialog(QtWidgets.QWidget, about_widget_class):
    ...
    """Espdrone client About box for debugging and information"""
    ...
    def __init__(self, helper, *args):
        ...
        self._name_label.setText(
            self._name_label.text().replace('#version#', edclient.VERSION))
    ...
    def showEvent(self, event):
        ...
        self._interface_text = ""
        interface_status = edlib.crtp.get_interfaces_status()
        ...
        for reader in edclient.utils.input.inputreaders.initialized_readers:
    ...
    def _connected(self, uri):
        """Callback when Espdrone is connected"""
        self._uri = uri
    ...
    def _disconnected(self, uri):
        """Callback for Espdrone disconnected"""
        self._interface_text = ""
        self._imu_sensors_text = ""
        self._imu_sensor_test_text = ""
        self._decks_text = ""
