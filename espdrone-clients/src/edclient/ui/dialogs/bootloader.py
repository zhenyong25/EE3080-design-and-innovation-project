...
"""
The bootloader dialog is used to update the Espdrone firmware and to
read/write the configuration block in the Espdrone flash.
"""
...
service_dialog_class = uic.loadUiType(edclient.module_path +
...
class BootloaderDialog(QtWidgets.QWidget, service_dialog_class):
    """Tab for update the Espdrone firmware and for reading/writing the config
    block in flash"""
