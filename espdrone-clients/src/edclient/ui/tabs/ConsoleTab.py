...
"""
The console tab is used as a console for printouts from the Espdrone.
"""
...
console_tab_class = uic.loadUiType(edclient.module_path +
                                   "/ui/tabs/consoleTab.ui")[0]


class ConsoleTab(Tab, console_tab_class):
    """Console tab for showing printouts from Espdrone"""
    ...
    def printText(self, text):
        # Make sure we get printouts from the Espdrone into the log (such as
