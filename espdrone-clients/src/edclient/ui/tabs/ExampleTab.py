...
"""
An example template for a tab in the Espdrone Client. It comes pre-configured
with the necessary QT Signals to wrap Espdrone API callbacks and also
...
example_tab_class = uic.loadUiType(edclient.module_path +
...
class ExampleTab(Tab, example_tab_class):
    ...
    def _disconnected(self, link_uri):
        ...
        logger.debug("Espdrone disconnected from {}".format(link_uri))
