...
import edclient
from edclient.ui.widgets.ai import AttitudeIndicator
...
flight_tab_class = uic.loadUiType(edclient.module_path +
    ...
    def __init__(self, tabWidget, helper, *args):
        ...
        self.helper.cf.param.add_update_callback(
            ...
            cb=(lambda name, checked:
                self.espdroneXModeCheckbox.setChecked(eval(checked))))
