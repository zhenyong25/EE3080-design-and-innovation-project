...
"""
Shows the Log TOC of available variables in the Espdrone.
"""
...
param_tab_class = uic.loadUiType(edclient.module_path +
                                 "/ui/tabs/logTab.ui")[0]
...
class LogTab(Tab, param_tab_class):
    ...
    def __init__(self, tabWidget, helper, *args):
        ...
        # Clear the log TOC list when the Espdrone is disconnected
