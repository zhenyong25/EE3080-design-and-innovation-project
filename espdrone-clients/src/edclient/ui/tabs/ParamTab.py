...
param_tab_class = uic.loadUiType(
    edclient.module_path + "/ui/tabs/paramTab.ui")[0]
...
class ParamChildItem(object):
    ...
    def __init__(self, parent, name, espdrone):
        """Initialize the node"""
        self.parent = parent
        self.name = name
        self.ctype = None
    ...
    def set_value(self, value):
        """Send the update value to the Espdrone. It will automatically be
...
class ParamBlockModel(QAbstractItemModel):
    ...
    def setData(self, index, value, role):
        ...
        if role == Qt.EditRole:
            ...
            # reading of the parameter from the Espdrone
