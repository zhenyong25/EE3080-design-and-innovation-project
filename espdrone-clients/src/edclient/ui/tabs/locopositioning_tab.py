...
from edclient.ui.dialogs.anchor_position_dialog import AnchorPositionDialog
...
locopositioning_tab_class = uic.loadUiType(
    edclient.module_path + "/ui/tabs/locopositioning_tab.ui")[0]
...
class LocoPositioningTab(Tab, locopositioning_tab_class):
    ...
    def _connected(self, link_uri):
        ...
        logger.info("Espdrone connected to {}".format(link_uri))
    ...
    def _start_polling_anchor_pos(self, espdrone):
