...
"""
A detachable toolbox for showing console printouts from the Espdrone
"""
...
console_class = uic.loadUiType(
    edclient.module_path + "/ui/toolboxes/consoleToolbox.ui")[0]


class ConsoleToolbox(QtWidgets.QWidget, console_class):
    """Console toolbox for showing printouts from the Espdrone"""
