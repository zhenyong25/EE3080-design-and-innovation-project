...
"""
Module to read input devices and send controls to the Espdrone.

This module reads input from joysticks or other input devices and sends control
set-points to the Espdrone. It can be configured in the UI.
...
from edclient.utils.periodictimer import PeriodicTimer
...
class JoystickReader(object):
    ...
    def __init__(self, do_device_discovery=True):
        ...
        for f in glob.glob(
                edclient.module_path + "/configs/input/[A-Za-z]*.json"):
