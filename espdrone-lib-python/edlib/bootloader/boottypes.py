...
class BootVersion:
    ed1_PROTO_VER_0 = 0x00
    ed1_PROTO_VER_1 = 0x01
    ed2_PROTO_VER = 0x10

    @staticmethod
    def to_ver_string(ver):
        if (ver == BootVersion.ed1_PROTO_VER_0 or ver == BootVersion.
                ed1_PROTO_VER_1):
            return 'Espdrone Nano Quadcopter (1.0)'
        if ver == BootVersion.ed2_PROTO_VER:
            return 'Espdrone 2.0'
        return 'Unknown'

    @staticmethod
    def is_ed2(ver):
        return ver == BootVersion.ed2_PROTO_VER
