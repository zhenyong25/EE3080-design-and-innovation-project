...
#  MA  02110-1301, USA.
"""
Fake link driver used to debug the UI without using the Espdrone.
...
from edlib.espdrone.log import LogTocElement
from edlib.espdrone.param import ParamTocElement
