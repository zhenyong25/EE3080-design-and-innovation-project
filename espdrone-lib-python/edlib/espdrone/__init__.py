...
#  MA  02110-1301, USA.
"""
The Espdrone module is used to easily connect/send/receive data
from a Espdrone.

Each function in the Espdrone has a class in the module that can be used
to access that functionality. The same design is then used in the Espdrone
...
from edlib.espdrone.high_level_commander import HighLevelCommander
