...
#  MA  02110-1301, USA.
"""
Used for sending high level setpoints to the Espdrone
"""
import struct
...
class HighLevelCommander():
    ...
    def set_group_mask(self, group_mask=ALL_GROUPS):
        """
        Set the group mask that the Espdrone belongs to

        :param group_mask: mask for which groups this ed belongs to
        """
    ...
    def takeoff(self, absolute_height_m, duration_s, group_mask=ALL_GROUPS):
        ...
        :param duration_s: time it should take until target height is
                           reached (s)
        :param group_mask: mask for which eds this should apply to
        """
