...
class Toedetcher:
    """Fetches TOC entries from the Espdrone"""

    def __init__(self, espdrone, element_class, port, toc_holder,
    ...
    def _toc_fetch_finished(self):
        ...
        self.ed.remove_port_callback(self.port, self._new_packet_cb)
