...
Espdrone around. Some sort of positioning support is required, for instance
the Flow deck.
...
class MotionCommander:
    ...
    def __init__(self, espdrone, default_height=0.3):
        """
    ...
    def take_off(self, height=None, velocity=VELOCITY):
        ...
        self._thread = _SetPointThread(self._ed)
        self._thread.start()
    ...
    def land(self, velocity=VELOCITY):
        ...
        if self._is_flying:
            ...
            self._ed.commander.send_stop_setpoint()
            self._is_flying = False
...
class _SetPointThread(Thread):
    ...
    def __init__(self, ed, update_period=UPDATE_PERIOD):
    ...
    def get_height(self):
        """
        Get the current height of the Espdrone.
    ...
    def run(self):
        while True:
            ...
            self._ed.commander.send_hover_setpoint(*self._hover_setpoint)
