...
#  MA  02110-1301, USA.
"""
This example connects to the first Espdrone that it finds and writes to the
one wire memory.

Note: this example will not work with the BLE version of the nRF51 firmware
(flashed on production units).
See https://github.com/bitcraze/espdrone-clients-python/issues/166
"""
import logging
import sys
import time
...
from edlib.espdrone.mem import OWElement
